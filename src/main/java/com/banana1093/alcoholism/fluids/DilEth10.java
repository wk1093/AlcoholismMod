...
public abstract class DilEth10 extends CustomFluid {
    ...
    public Fluid getFlowing() {
        return Alcoholism.FLOWING_DILETH10;
    }

    @Override
    public Item getBucketItem() {
        return Alcoholism.BUCKET_DILETH10;
    }

    @Override
    protected BlockState toBlockState(FluidState fluidState) {
        return Alcoholism.DILETH10.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(fluidState));
    }
    ...
    public static class Flowing extends DilEth10 {
        @Override
    ...
    public static class Still extends DilEth10 {
        @Override
        public int getLevel(FluidState fluidState) {
            return 8;
        }
